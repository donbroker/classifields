...
<form action="" method="post" class="adverts-form adverts-form-aligned">
    <fieldset>
        ...
        <?php if (!is_user_logged_in ()) :?>
            <hr>
            <h5><i>Đăng kí hoặc đăng nhập bằng facebook hoặc google để theo dõi tin rao</i></h5>
            <?php echo do_shortcode("[wordpress_social_login]");?>
        <?php endif; ?>

        <div  style="border-top:2px solid silver; padding: 1em 0 1em 0" class="mobile-review-center">
            <input style="background-color: orange; border-color: orange;" type="submit" name="submit" value="<?php _e("Preview", "adverts") ?>" style="font-size:1.2em" class="btn btn-success" />
        </div>
