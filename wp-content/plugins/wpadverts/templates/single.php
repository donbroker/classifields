...
<div class="adverts-single-box">
    <div class="adverts-single-author">
        ...
        <div class="adverts-single-author-name">
            ...
            <?php
            printf( __('Published: %1$s (%2$s ago)', "adverts"), date_i18n( get_option( 'date_format' ),
...
<div class="pull-right">
  <div class="fb-share-button" data-href="<?php the_permalink()?>" data-layout="button" data-mobile-iframe="true"><a class="fb-xfbml-parse-ignore" target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink()?>src=sdkpreparse">Chia sẻ</a></div>
</div>
<div width="500" class="fb-comments" data-href="<?php the_permalink()?>" data-numposts="5"></div>
