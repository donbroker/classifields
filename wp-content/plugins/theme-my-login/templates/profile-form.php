...
<div class="tml tml-profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form id="your-profile" action="<?php $template->the_action_url( 'profile', 'login_post' ); ?>" method="post">
		...
		<tr class="tml-user-login-wrap">
			...
			<td><input type="text" name="user_login" id="user_login" value="<?php echo esc_attr( $profileuser->user_login ); ?>" disabled="disabled" class="form-control regular-text" /> <span class="description"><?php _e( 'Usernames cannot be changed.', 'theme-my-login' ); ?></span></td>
		</tr>
		...
		<tr class="tml-user-email-wrap">
			...
			<td><input type="text" name="email" id="email" value="<?php echo esc_attr( $profileuser->user_email ); ?>" class="form-control regular-text" /></td>
			<?php
		...
		<tr class="tml-user-phone_number-wrap">
			<th><label for="user_phone"><?php _e( 'Số điện thoại', 'theme-my-login' ); ?></label></th>
			<td><input type="text" name="user_phone" id="user_phone" value="<?php echo esc_attr( $profileuser->user_phone); ?>" class="form-control regular-text code" /></td>
		</tr>
<!-- 
 ...
 -->
		...
		<p class="tml-submit-wrap">
			...
			<input type="submit" class="btn btn-success button-primary" value="<?php esc_attr_e( 'Update Profile', 'theme-my-login' ); ?>" name="submit" id="submit" />
		</p>
	</form>
</div>
